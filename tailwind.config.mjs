...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Texas-inspired palette: Deep blue, burnt orange, warm earth
        texas: {
          blue: {
            50: '#eff6ff',
            100: '#dbeafe',
        ...
        // Dark grays with warm undertone
        dark: {
          DEFAULT: '#1c1917',
          50: '#fafaf9',
          100: '#f5f5f4',
      ...
      backgroundImage: {
        'texas-gradient': 'linear-gradient(135deg, #1e40af 0%, #172554 50%, #1c1917 100%)',
